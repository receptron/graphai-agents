...
exports.serperAgent = void 0;
const axios_1 = __importDefault(require("axios"));
const serperAgent = async ({ namedInputs }) => {
...
const serperAgentInfo = {
    name: "serperAgent",
    agent: exports.serperAgent,
    mock: exports.serperAgent,
    samples: [
        {
            params: {},
...
exports.default = serperAgentInfo;
